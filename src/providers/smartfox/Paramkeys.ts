export class Paramskey {
	...
	public static CMD: string = "cmd";

	public static MESSAGE: string = "message";
	public static ROOM_NAME: string = "room_name";

	public static FORM_SERVICE: string = "form_service";
	public static TYPE_SERVICE: string = "type_service";
	...
	public static FLOOR_ID: string = "floor_id";
	...
	public static STAFF_CREATE: string = "staff_create";
	public static STAFF_PAYMENT: string = "staff_payment";
	public static CODE: string = "code";
	public static TOTAL_MONEY: string = "total_money";
	public static TIME_CREATED: string = "time_created";
	public static TIME_PAYMENT: string = "time_payment";
	...
	public static DISCOUNT_ID: string = "discount_id";
	public static PERCENT_ORDER_DISCOUNT: string = "percent_order_discount";
	...
	public static CUSTOMER_ADDRESS = "customer_address";
	public static CUSTOMER_PHONE = "customer_phone";
	public static VENDOR_ID = "vendor_id";
	public static COMBO_ID = "combo_id";
